...
public class DictData extends BaseEntity {
	...
	public void setDictLink(String dictLink) {
	...
	public String toString() {
		return "DictData [dictCode=" + dictCode + ", dictSort=" + dictSort + ", dictLabel=" + dictLabel + ", dictValue="
				+ dictValue + ", dictType=" + dictType + ", dictLink=" + dictLink + ", cssClass=" + cssClass
				+ ", listClass=" + listClass + ", isDefault=" + isDefault + ", status=" + status + "]";
	}
}
