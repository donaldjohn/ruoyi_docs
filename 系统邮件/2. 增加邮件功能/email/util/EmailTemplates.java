package com.ruoyi.project.tool.email.util;
...
public class EmailTemplates {
	...
	public static String getTemplate(String subject,String msg) {
		...
		sbf.append("<body><div style=\"height:30px;display:inline-block;padding:10px 10px 0px 10px;background-color:#1ab394;color:#fff;font-weight:bold;\">若依邮件</div>");
