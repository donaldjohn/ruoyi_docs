(function ($) {
    ...
    $.fn.extend({
        cronGen: function (options) {
            ...
            var mainDiv = $("<div/>", { id: "CronGenMainDiv", style: "width:480px;height:320px;" });
            ...
            var tabContent = $("<div/>", { "class": "tab-content", "style": "border:0px;" });
            ...
            $(secondsTab).append('<div class="imp secondList"><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="0"><span>00</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="1"><span>01</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="2"><span>02</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="3"><span>03</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="4"><span>04</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="5"><span>05</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="6"><span>06</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="7"><span>07</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="8"><span>08</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="9"><span>09</span></div>');
            $(secondsTab).append('<div class="imp secondList"><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="10"><span>10</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="11"><span>11</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="12"><span>12</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="13"><span>13</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="14"><span>14</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="15"><span>15</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="16"><span>16</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="17"><span>17</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="18"><span>18</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="19"><span>19</span></div>');
            $(secondsTab).append('<div class="imp secondList"><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="20"><span>20</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="21"><span>21</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="22"><span>22</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="23"><span>23</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="24"><span>24</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="25"><span>25</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="26"><span>26</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="27"><span>27</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="28"><span>28</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="29"><span>29</span></div>');
            $(secondsTab).append('<div class="imp secondList"><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="30"><span>30</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="31"><span>31</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="32"><span>32</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="33"><span>33</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="34"><span>34</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="35"><span>35</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="36"><span>36</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="37"><span>37</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="38"><span>38</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="39"><span>39</span></div>');
            $(secondsTab).append('<div class="imp secondList"><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="40"><span>40</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="41"><span>41</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="42"><span>42</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="43"><span>43</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="44"><span>44</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="45"><span>45</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="46"><span>46</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="47"><span>47</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="48"><span>48</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="49"><span>49</span></div>');
            $(secondsTab).append('<div class="imp secondList"><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="50"><span>50</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="51"><span>51</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="52"><span>52</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="53"><span>53</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="54"><span>54</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="55"><span>55</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="56"><span>56</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="57"><span>57</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="58"><span>58</span><input type="checkbox" disabled="disabled" style="margin-left: 5px"  value="59"><span>59</span></div>');
            ...
            $b.popover({
                ...
                template: '<div class="popover" style="max-width:515px !important; width:515px;height:365px;"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>',
