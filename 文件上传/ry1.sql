...
-- ----------------------------
-- Table structure for play_order
-- ----------------------------
DROP TABLE IF EXISTS `play_order`;
CREATE TABLE `play_order` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT,
  `fileName` varchar(50) DEFAULT '',
  `type` int(20) DEFAULT '0' COMMENT '0 图片 1 视频 2 文字',
  `ur` varchar(50) DEFAULT '',
  `content` varchar(5000) DEFAULT '',
  `order` int(11) DEFAULT '0' COMMENT '播放顺序',
  `remark` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='播放顺序表';

-- ----------------------------
-- Records of play_order
-- ----------------------------
INSERT INTO `play_order` VALUES ('1', '图片1', '0', 'http://lorempixel.com/1920/1080/transport/1', '', '1', '');
INSERT INTO `play_order` VALUES ('2', '图片2', '0', 'http://lorempixel.com/1920/1080/transport/2', '', '2', '');
INSERT INTO `play_order` VALUES ('3', '视频1', '1', 'http://www.w3school.com.cn/i/movie.ogg', '', '3', '');
INSERT INTO `play_order` VALUES ('4', '视频2', '1', 'http://www.w3school.com.cn/i/movie.ogg', '', '4', '');
INSERT INTO `play_order` VALUES ('5', '文字', '2', '撒大苏打实打实大苏打实打实', '<h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 我是标题</h1><div>&nbsp; &nbsp; &nbsp; 我是内容，你好！<span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit; background-color: rgb(0, 0, 255);\">&nbsp;</span><span style=\"color: inherit;\"><span style=\"background-color: rgb(0, 0, 255);\">我是蓝色</span>！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！<span style=\"background-color: rgb(255, 0, 0);\">我是红色</span></span></div>', '0', '');
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-6AE14EF1545898826380', '1545898861099', '15000');
...
-- ----------------------------
INSERT INTO `sys_files` VALUES ('42', 'D:/profile/图片1.jpg', '0', '图片1', '我使备注', null, 'jpg', '0', '0', '管理员', 'admin', '2018-12-21 11:36:40', '', '', '2018-12-27 10:34:37');
INSERT INTO `sys_files` VALUES ('46', 'D:/profile/测试1.mp4', '0', '测试1', '', null, 'mp4', '1', '0', '管理员', 'admin', '2018-12-21 14:58:23', '', '', null);
INSERT INTO `sys_files` VALUES ('48', '', '0', '测试文字', '', '<h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 我是标题</h1><div>&nbsp; &nbsp; &nbsp; 我是内容，你好！<span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit; background-color: rgb(0, 0, 255);\">&nbsp;</span><span style=\"color: inherit;\"><span style=\"background-color: rgb(0, 0, 255);\">我是蓝色</span>！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！</span><span style=\"color: inherit;\">&nbsp;</span><span style=\"color: inherit;\">我是内容，你好！<span style=\"background-color: rgb(255, 0, 0);\">我是红色</span></span></div>', '', '2', '0', '管理员', 'admin', '2018-12-25 16:56:06', '', '', '2018-12-26 08:51:42');
INSERT INTO `sys_files` VALUES ('49', 'D:/profile/图片2.jpg', '0', '图片2', '我是备注', '', 'jpg', '0', '0', '管理员', 'admin', '2018-12-26 09:16:37', '', '', null);
INSERT INTO `sys_files` VALUES ('65', 'D:/profile/图片4567.jpg', '0', '图片4567', '', '', 'jpg', '0', '0', '管理员', 'admin', '2018-12-26 11:20:14', '', '', '2018-12-26 11:21:30');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
...
INSERT INTO `sys_menu` VALUES ('1064', '显示页面', '1057', '3', '/file/show', 'C', '0', '', '#', 'admin', '2018-12-26 16:20:31', '', null, '');
INSERT INTO `sys_menu` VALUES ('1065', '播放设置', '1057', '2', '/file/listOrderPage', 'C', '0', '', '#', 'admin', '2018-12-27 08:32:33', 'admin', '2018-12-27 08:46:08', '');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=314 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '管理员', '00', 'ry@163.com', '15888888888', '0', '9bb570b323da9d39bcc855b65ca65424.jpg', 'e6314415342e92e189629f2233b15e55', 'd86bae', '0', '0', '127.0.0.1', '2018-12-27 16:12:05', 'admin', '2018-03-16 11:33:00', 'ry', '2018-12-27 16:12:04', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('950f9619-7717-458b-9aef-20963f7ba0ad', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2018-12-27 16:12:01', '2018-12-27 16:13:15', '1800000');
